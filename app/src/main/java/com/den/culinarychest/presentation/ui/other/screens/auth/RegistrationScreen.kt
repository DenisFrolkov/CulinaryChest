...
fun Registration(
    ...
    val regState by registrationApplicationUser.regState.collectAsState()
    ...
    Column(
        ...
        when (regState) {
            ...
            is ProcessingResult.Success -> {
                if ((regState as ProcessingResult.Success).data == true) {
                    registrationApplicationUser.clearState()
